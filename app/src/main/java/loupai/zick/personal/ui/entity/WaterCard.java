package loupai.zick.personal.ui.entity;
...
public class WaterCard {
    ...
    public WaterCard(String id, String code, String password, Integer type, Integer status, Float balance, String remark, String phone, Integer def, String watermeterCode, String ctime, String userId) {
        this.id = id;
        this.code = code;
